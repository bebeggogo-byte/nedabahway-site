...
CARDS = {
    ...
    "planning/02-competitor-news-digest": {
        ...
        "level": "★★",
        "time": "45분",
        "prereq": "구글 계정 + Gemini API 키 + (선택) Slack",
        "for_starter": False,
    },
    "planning/03-weekly-kpi-report": {
        ...
        "level": "★★",
        "time": "60분",
        "prereq": "KPI 적재된 Google Sheet + Gemini API 키",
        "for_starter": False,
    },
    "hr/01-onboarding-kit": {
        ...
        "level": "★★",
        "time": "60분",
        "prereq": "구글 Workspace + Docs 템플릿 2개 + (선택) Slack",
        "for_starter": True,
    },
    "hr/02-leave-approval-workflow": {
        ...
        "level": "★★★",
        "time": "90분",
        "prereq": "Slack App(Bot Token) + Form + 팀장 Slack ID 매핑",
        "for_starter": False,
    },
    "hr/03-pulse-survey-sentiment": {
        ...
        "level": "★★",
        "time": "45분",
        "prereq": "Google Form + Gemini API 키",
        "for_starter": False,
    },
    ...
    "marketing/02-lead-scoring-router": {
        ...
        "level": "★★",
        "time": "60분",
        "prereq": "Google Form + Gemini API 키 + Slack Bot",
        "for_starter": False,
    },
    "marketing/03-review-mention-digest": {
        ...
        "level": "★★",
        "time": "45분",
        "prereq": "네이버 검색 API 키 + Gemini API 키",
        "for_starter": False,
    },
}
