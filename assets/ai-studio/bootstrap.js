...
(function(){
  ...
  const ASSETS = [
    ...
    {tag:'link', rel:'stylesheet', href:BASE+'slides.css'},
    {tag:'script', src:BASE+'v2.js', defer:true},
    {tag:'script', src:BASE+'block6.js', defer:true},
    {tag:'script', src:BASE+'slides.js', defer:true}
  ];
  ...
  function selfCheck(){
    const checks = {
      ...
      slidesCss: !!document.querySelector('link[href*="ai-studio/slides.css"]'),
      v2js: !!document.querySelector('script[src*="ai-studio/v2.js"]'),
      block6js: !!document.querySelector('script[src*="ai-studio/block6.js"]'),
      slidesJs: !!document.querySelector('script[src*="ai-studio/slides.js"]'),
