...
- 남은 선지서: ISA 24(43~66) → JER 52 → LAM 5 → EZK 48 → DAN 12 → 소선지서 12권(HOS~MAL 67장) (158장). ISA phases: 1~12 심판·임마누엘 / 13~27 열방심판·묵시록 / 28~35 화와 모퉁잇돌 / 36~39 히스기야경첩 / 40~55 위로의책·종의노래 / 56~66 새하늘새땅. 선지서 17권 흐름 전부 book-telos.json 기록 완료
